...
class RouterOutlet extends LitElement {
    ...
    static routes: Route[] = [
        ...
        {path: '/posts', component: 'posts-component'},
        {path: '/user', component: 'user-component'},
        {path: '/heisenberg', component: 'heisenberg-component'},
        {path: '/selina', component: 'selina-component'},
        {path: '/jacqui', component: 'jacqui-component'},
    ];
    ...
    render() {
        ...
        return html`
            <nav @click=${this.onNavigate}>
                <a href="/heisenberg">Say my name</a>
                <a href="/jacqui">jacqui</a>
            </nav>
            <div id="outlet"></div>
        `;
    }
