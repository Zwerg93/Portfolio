...
import userService from "../../service/http.service"
...
export class SongComponent extends HTMLElement {
    ...
    render(users: Array<User>) {
        ...
        const userClicked = (user: User) => {
            alert(`user ${user.username} selected`)
...
customElements.define("song-component", SongComponent)